Midas Gold Public Relations
==============================

Midas Gold Public Relations Database
...
.. code-block:: bash
    ...
    cd midas_pr
    celery -A midas_pr.taskapp worker -l info
...
To run the tests, enter the midas_pr/tests directory and run the following commands::
